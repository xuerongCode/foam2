...
public abstract class AbstractJDBCDAO 
  extends AbstractDAO
{
  protected ConnectionPool connectionPool_;
  protected String table_;
  protected List<PropertyInfo> props_ = new ArrayList<>();

  public AbstractJDBCDAO(X x, ClassInfo of, String connectionPoolId) {
    this(x, of, (ConnectionPool) x.get(connectionPoolId));
  }

  public AbstractJDBCDAO(X x, ClassInfo of, ConnectionPool connectionPool) {
    setX(x);
    setOf(of);
...
//      prop.set(obj, resultSet.getObject(index++));
   ...
   */
  protected void buildFormattedColumnNames(FObject obj, StringBuilder builder) {
...
/*       if ( "id".equals(prop.getName()) )
   ...
   * @param builder builder to append to
   */
  protected void buildFormattedColumnPlaceholders(FObject obj, StringBuilder builder) {
...
/*       if ( "id".equals(prop.getName()) )
   ...
   * @throws SQLException
   */
  protected void setStatementValues(IndexedPreparedStatement stmt, FObject obj) throws SQLException {
    Iterator i = props_.iterator();
    while ( i.hasNext() ) {
      PropertyInfo prop = (PropertyInfo) i.next();
   ...
   * @param c Connection
   */
  protected void closeAllQuietly(ResultSet resultSet, IndexedPreparedStatement stmt, Connection c) {
    if ( resultSet != null )
